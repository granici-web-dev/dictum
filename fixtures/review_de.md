...
Проверять поля формы входа в браузере, пока ничего не ушло на сервер: формат e-mail и обязательные поля. Зачем это нужно, на встрече не прозвучало. API не трогать, он принадлежит команде бэкенда.
...
Перевести сообщения об ошибках на странице аккаунта с английского на немецкий; тексты пришлёт Julia из продуктовой команды. Зачем, на встрече не прозвучало. Срочность ниже, чем у проверки формы входа, срок не назван.
