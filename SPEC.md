...
- Карточка с маркером, у которой не хватает чеклиста DoD, его пунктов или ссылок на зависимости, дособирается: оборвавшийся прогон успевает создать карточку раньше, чем наполнить её, и без досборки она осталась бы недоделанной навсегда. Пункты сверяются по именам, недостающие дописываются в конец; существующий чеклист не пересоздаётся, чтобы не терять отметки. В выводе это «уже есть, дособрана».
