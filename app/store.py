...
# задания в ней нет, а этого никто не знает. С P3-09 не заводится — ставил его только поздний
# отказ по длине, — но читается из старых строк, и выкидывать его нельзя.
REFUSED = "refused"
DROPPED = "dropped"
FAILED = "failed"
